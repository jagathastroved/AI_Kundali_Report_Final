...
export const KundaliReportBook: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-transparent flex flex-col lg:flex-row overflow-hidden relative">
      ...
      <div
        className={`lg:hidden fixed inset-0 bg-slate-900/40 z-40 transition-opacity duration-300 ${isSidebarOpen
      ...
      <aside
        className={`fixed lg:sticky lg:top-0 top-0 left-0 z-50 lg:z-20 border-r border-default sidebar-bg flex-shrink-0 transition-all duration-300 ease-in-out flex flex-col h-[100dvh] overscroll-contain ${isSidebarOpen
      ...
      >
        ...
        <div className="flex-1 overflow-y-auto custom-scrollbar overscroll-contain min-h-0">
        ...
        {[
          ...
          >
            ...
            <div className="flex items-center justify-between pb-4 mb-6 border-b border-slate-100 relative">
              <div className="flex-1 flex justify-start">
                <a href="https://www.astroved.com" target="_blank" rel="noopener noreferrer">
                  <AstroVedLogoSVG className="h-8 w-auto" />
                </a>
              </div>
              <div className="flex-[2] sm:flex-none flex flex-col items-center justify-center text-center px-2">
