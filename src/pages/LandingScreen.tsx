...
export const LandingScreen: React.FC = () => {
  ...
  return (
    <div className="w-full bg-slate-50 text-slate-900 flex flex-col items-center justify-start relative overflow-hidden z-10">
        ...
        <div className="w-full max-w-7xl mx-auto flex flex-col md:grid md:grid-cols-12 gap-10 lg:gap-12 items-stretch z-10">
          ...
          <div className="flex flex-col text-left w-full md:col-span-7 relative justify-start md:pr-4">
            <div>
              ...
              <p className="text-slate-200 text-[14.5px] sm:text-base leading-relaxed mb-5 relative z-10 max-w-xl">
      ...
      <div className="w-full bg-white relative overflow-hidden py-6 lg:py-8 border-t border-slate-200">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 lg:grid-rows-[auto_1fr] gap-x-10 lg:gap-x-16 gap-y-6 items-center lg:items-start">
            ...
            <div className="relative lg:col-start-2 lg:row-start-1 lg:row-span-2 lg:self-center">
              <div className="relative w-full max-w-[280px] sm:max-w-[320px] lg:max-w-[380px] mx-auto lg:ml-auto lg:mr-0">
                <div className="absolute inset-0 bg-gradient-to-tr from-indigo-400/20 to-purple-400/20 rounded-2xl blur-xl mix-blend-multiply"></div>
              </div>
            </div>
            ...
            <div className="space-y-4 text-slate-900 text-[15px] sm:text-[16px] leading-[1.8] lg:col-start-1 lg:row-start-2 lg:self-start">
              ...
              <ul className="list-disc pl-6 space-y-2.5 marker:text-[#6B40C3] marker:font-bold">
                ...
                <li>Your unique <a href="https://www.astroved.com/blogs/how-planets-influence-daily-life" target="_blank" rel="noopener noreferrer" className="text-[#6B40C3] font-semibold underline underline-offset-4 decoration-[#6B40C3]/40 hover:decoration-[#6B40C3] transition-colors">planetary placements</a></li>
                <li>Significant Yogas and Doshas</li>
                <li><a href="https://www.astroved.com/blogs/effects-of-planets-in-different-houses" target="_blank" rel="noopener noreferrer" className="text-[#6B40C3] font-semibold underline underline-offset-4 decoration-[#6B40C3]/40 hover:decoration-[#6B40C3] transition-colors">12 Houses</a> and Patterns linked to career, love, money, and well-being</li>
          ...
          <div>
            ...
            <div className="space-y-4 text-slate-900 text-[15px] sm:text-[16px] leading-[1.8]">
              ...
              <div className="space-y-6">
                <div>
                  <h3 className="text-[18px] sm:text-[20px] font-bold text-[#2E2459] mb-1.5">Mangal Dosha (Manglik)</h3>
                  <p className="mb-1.5">Mars in the 1st, 4th, 7th, 8th, or 12th house from Ascendant, Moon, or Venus. Closer to half of all charts carry it, which is why our sages left gentle exceptions - Mars in its own sign, blessed by Jupiter, or both partners sharing it.</p>
                  <p className="mb-1.5"><strong className="text-slate-900 font-bold">Remedies:</strong> <a href="https://www.astroved.com/instant-pooja/mars-pooja" target="_blank" rel="noopener noreferrer" className="text-[#6B40C3] font-semibold underline underline-offset-4 decoration-[#6B40C3]/40 hover:decoration-[#6B40C3] transition-colors">Instant poojas</a> like Kumbh Vivah, red coral (with guidance), Hanuman Chalisa on Tuesdays.</p>
                  <p>You can also check whether Mangal Dosha is present in your birth chart using AstroVed’s<a href="https://www.astroved.com/astropedia/en/freetools/manglik" className="text-[#6B40C3] underline underline-offset-4 decoration-[#6B40C3]/40 font-semibold hover:text-[#4F2D96] transition-colors"> Calculate Mangal Dosha</a></p>
                </div>

                <div>
                  <h3 className="text-[18px] sm:text-[20px] font-bold text-[#2E2459] mb-1.5">Kaal Sarp Dosha</h3>
                  <p className="mb-1.5">All seven planets between Rahu and Ketu. A later addition to our texts, weighed differently across traditions.</p>
                  <p className="mb-1.5"><strong className="text-slate-900 font-bold">Remedy:</strong> <a href="https://www.astroved.com/us/specials/kala-sarpa-dosha" target="_blank" rel="noopener noreferrer" className="text-[#6B40C3] font-semibold underline underline-offset-4 decoration-[#6B40C3]/40 hover:decoration-[#6B40C3] transition-colors">Kaal Sarp Puja</a> at Trimbakeshwar, a silver Naga pendant.</p>
                  <p>Check whether Kaal Sarp Dosha is present in your birth chart using AstroVed’s<a href="https://www.astroved.com/astropedia/en/freetools/naga-dosha" className="text-[#6B40C3] underline underline-offset-4 decoration-[#6B40C3]/40 font-semibold hover:text-[#4F2D96] transition-colors"> Calculate Kaal Sarp Dosha</a></p>
                </div>

                <div>
                  <h3 className="text-[18px] sm:text-[20px] font-bold text-[#2E2459] mb-1.5">Pitru Dosha</h3>
                  <p className="mb-1.5">Seen through the Sun touched by Rahu, Ketu, or Saturn near the 9th house - our bond with those who came before.</p>
                  <p className="mb-1.5"><strong className="text-slate-900 font-bold">True remedy:</strong> <a href="https://www.astroved.com/us/specials/tarpanam-ritual-package" target="_blank" rel="noopener noreferrer" className="text-[#6B40C3] font-semibold underline underline-offset-4 decoration-[#6B40C3]/40 hover:decoration-[#6B40C3] transition-colors">Tarpan</a>, a simple offering of water and sesame.</p>
                  <p>Find out whether Pitru Dosha is indicated in your birth chart using AstroVed’s<a href="https://www.astroved.com/astropedia/en/freetools/pitru-dosha" className="text-[#6B40C3] underline underline-offset-4 decoration-[#6B40C3]/40 font-semibold hover:text-[#4F2D96] transition-colors"> Check Pitru Dosha</a></p>
                </div>
      ...
      <div className="w-full bg-gray-100 relative overflow-hidden py-6 lg:py-8 border-t border-purple-200/50">
        ...
        <div className="w-full max-w-7xl mx-auto px-4 md:px-8 lg:px-12 relative z-10 text-left">
          <div>
            ...
            <div className="space-y-4 text-slate-900 text-[15px] sm:text-[16px] leading-[1.8]">
              <p>
                Most Kundali reports are generated instantly by software - enter a birth date, get a PDF. AstroVed's paid report is different: it's personally drafted by a qualified astrologer with <strong className="text-slate-900 font-bold">10+ years of experience</strong>, not an algorithm.
              </p>
              <p>
              ...
              <p className="font-bold text-[#6B40C3] text-[16.5px]">
      ...
      <div className="w-full bg-white relative overflow-hidden py-10 lg:py-14 border-t border-slate-200">
        <div className="w-full max-w-7xl mx-auto px-4 md:px-8 lg:px-12 relative z-10 flex flex-col items-center">

          <section className="w-full">
            {/* Header */}
            <div className="flex flex-col items-center text-center mb-8 sm:mb-10">
              <h3 className="text-2xl sm:text-3xl font-serif font-bold text-[#2E2459] mb-2 tracking-tight">
                Try Other Tools
              </h3>
              <p className="text-slate-800 text-sm sm:text-base max-w-xl font-medium">
                Explore our free Vedic calculation tools to get deeper insights into your birth chart and planetary placements.
              </p>
            </div>

            {/* Grid */}
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8 max-w-5xl mx-auto px-2">
              {[
                {
                  name: 'Horoscope Matching',
                  subtitle: '(Kundali Milan & Compatibility)',
                  image: horoscopeMatching,
                  url: 'https://www.astroved.com/astropedia/en/freetools/horoscope-matching',
                  btnText: 'Check Compatibility'
                },
                {
                  name: 'Moon Sign Calculator',
                  subtitle: '(Find your Rasi & Nakshatra)',
                  image: MoonSignImg,
                  url: 'https://www.astroved.com/astropedia/en/freetools/moon-sign-calculator',
                  btnText: 'Calculate Moon Sign'
                },
                {
                  name: 'Lagna Calculator',
                  subtitle: '(Discover your Ascendant sign)',
                  image: LagnaCalculatorImg,
                  url: 'https://www.astroved.com/astropedia/en/freetools/lagna-calculator',
                  btnText: 'Calculate Lagna'
                }
              ].map((tool, idx) => (
                <div
                  key={idx}
                  className="bg-white rounded-2xl p-4 sm:p-5 relative shadow-[0_4px_20px_rgba(0,0,0,0.04)] hover:shadow-[0_10px_30px_rgba(107,64,195,0.14)] hover:-translate-y-1.5 transition-all duration-300 flex flex-col border border-slate-200 group"
                >
                  {/* Badge */}
                  <div className="absolute top-0 left-0 bg-[#6B40C3] text-white text-xs sm:text-sm font-bold px-3.5 py-1.5 rounded-tl-2xl rounded-br-xl z-10 shadow-xs">
                    0{idx + 1}
                  </div>

                  {/* Circular Image Wrapper */}
                  <div className="relative w-[65%] sm:w-[70%] aspect-square mx-auto mt-4 mb-4 overflow-hidden rounded-full border-2 border-purple-100/60 shadow-md">
                    <img
                      src={tool.image}
                      alt={tool.name}
                  ...
                  <div className="text-center flex flex-col items-center flex-grow">
                    {/* Decorative Card Divider */}
                    <div className="flex items-center justify-center gap-3 mb-2.5 w-28">
                      <span className="h-[1px] flex-grow bg-[#6B40C3]/30"></span>
                      <span className="text-[#6B40C3] flex items-center justify-center">
                        <Sparkles size={14} />
                      </span>
                      <span className="h-[1px] flex-grow bg-[#6B40C3]/30"></span>
                    </div>
                    ...
                    {/* Title */}
                    <h4 className="text-[#2E2459] font-serif font-bold text-base sm:text-lg mb-1 leading-snug">
                      {tool.name}
                    </h4>

                    {/* Subtitle */}
                    <p className="text-slate-700 text-xs sm:text-sm mb-5 leading-snug font-medium">
                      {tool.subtitle}
                    </p>
                    ...
                    <a
                      ...
                      className="w-full mt-auto inline-flex items-center justify-center gap-2 px-4 py-2.5 bg-white border border-purple-200 text-[#6B40C3] font-bold text-sm rounded-lg hover:bg-purple-50 hover:border-purple-300 transition-all duration-200 shadow-xs"
                    >
                      {tool.btnText} <span className="group-hover:translate-x-1 transition-transform">→</span>
                    </a>
                  </div>
                </div>
              ))}
      ...
      <div className="w-full bg-[radial-gradient(120%_120%_at_15%_10%,#312563_0%,#241a4a_100%)] relative overflow-hidden py-8 lg:py-12 border-t border-[#46367a]">
        <div className="w-full max-w-7xl mx-auto px-4 md:px-8 lg:px-12 relative z-10 flex flex-col items-center">
          <section className="w-full relative overflow-hidden py-4">
            ...
            <div className="flex flex-col gap-4 relative z-10 w-full max-w-3xl mx-auto">
              {faqs.map((faq, idx) => (
                <FaqItem
                  key={idx}
                  index={idx}
